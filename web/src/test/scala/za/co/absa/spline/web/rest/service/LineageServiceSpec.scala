...
class LineageServiceSpec extends AsyncFlatSpec with Matchers with MockitoSugar {
  ...
  */
  ...
  val lineage1 = DataLineage("AppId1", "AppName1", 0, 0, "0.0.42", Map.empty, Map.empty, Seq(
  ...
  val lineage2 = DataLineage("AppId2", "AppName2", 0, 0, "0.0.42", Map.empty, Map.empty, Seq(
  ...
  */
  ...
  private val lineageD = DataLineage("AppId", "AppNameD", 0, 0, "0.0.42", Map.empty, Map.empty,
  ...
  private val lineageE = DataLineage("AppId", "AppNameE", 0, 0, "0.0.42", Map.empty, Map.empty,
  ...
  private val lineageA = DataLineage("AppId", "AppNameA", 0, 0, "0.0.42", Map.empty, Map.empty,
    operations = Seq(
  ...
  private val lineageB = DataLineage("AppId", "AppNameB", 0, 0, "0.0.42", Map.empty, Map.empty,
    operations = Seq(
  ...
  private val lineageC = {
    ...
    DataLineage("AppId", "AppNameC", 0, 0, "0.0.42", Map.empty, Map.empty,
      operations = Seq(
