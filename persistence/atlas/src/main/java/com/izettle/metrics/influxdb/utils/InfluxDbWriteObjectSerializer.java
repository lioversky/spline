...
public class InfluxDbWriteObjectSerializer {
  ...
  private static final Pattern p = Pattern.compile("^application_\\d+_\\d+[_|.][a-z0-9]+[_|.](.*)");

  public String splitAppName(String name) {
  ...
  private void lineProtocol(InfluxDbPoint point, TimeUnit precision, StringBuilder stringBuilder) {
    String measurement = splitAppName(point.getMeasurement());
